        ...
        >
          <div className="overflow-hidden">
            ...
            >
              ...
              <a
                href="https://github.com/impersio/impersio"
                target="_blank"
                rel="noopener noreferrer"
                onClick={closeMobileSidebar}
                className="flex items-center gap-3 px-2.5 py-1.5 rounded-lg text-xs font-medium text-muted-foreground hover:bg-accent/30 hover:text-foreground transition-colors duration-150"
              ...
              <a
                href="mailto:support@impersio.me"
                target="_blank"
                rel="noopener noreferrer"
                onClick={closeMobileSidebar}
                className="flex items-center gap-3 px-2.5 py-1.5 rounded-lg text-xs font-medium text-muted-foreground hover:bg-accent/30 hover:text-foreground transition-colors duration-150"
...
export const AppSidebar = memo(({ user, isProUser }: AppSidebarProps) => {
  ...
  const handleShareVisibilityChange = async (visibility: VisibilityType) => {
    ...
    try {
      ...
      const shareUrl = visibility === 'public' ? `${window.location.origin}/share/${shareTarget.id}` : '';
      sileo.success({
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-row items-center gap-2 leading-none group-data-[collapsible=icon]:hidden">
                    <span className="font-sans font-bold tracking-tight text-xl">Impersio ai</span>
                    {user && isProUser && (
                      <div className="w-fit">
            ...
            <SidebarMenuItem>
              ...
              >
                ...
                >
                  ...
                  <span className="group-data-[collapsible=icon]:hidden">History &amp; Library</span>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
          )}
            ...
            <SidebarMenuItem>
              ...
              >
                <Link
                  ...
                  className="flex items-center gap-2 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:w-full"
                >
                  <XLogoIcon weight="regular" className="size-[18px]" />
            ...
            <SidebarMenuItem>
              ...
              >
                <Link
                  ...
                  className="flex items-center gap-2 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:w-full"
                >
                  <AudioLinesIcon width={18} height={18} />
          ...
          <SidebarMenu className="gap-0 p-2">
            ...
            <SidebarMenuItem className="group-data-[collapsible=icon]:hidden">
              <button
                ...
                className="flex items-center gap-3 rounded-xl px-3 py-2.5 bg-primary/5 hover:bg-primary/10 transition-colors w-full"
              >
