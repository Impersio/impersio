...
import { MessageSquare, X, LogOut, Trash2, Plus, LogIn } from 'lucide-react';
    ...
    <>
      ...
      `}>
        ...
        <div className="flex-1 overflow-y-auto px-2 pb-2">
          {!userId ? (
             <div className="p-4 flex flex-col items-center justify-center text-center mt-10">
        ...
        {userId && (
          <div className="p-4 border-t border-border">
             <button 
               ...
               className="w-full flex items-center gap-3 p-2 text-sm text-muted hover:text-red-500 transition-colors rounded-lg hover:bg-surface-hover"
             >
